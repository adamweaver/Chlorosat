...
3. ~~Adam deploys with `deploy.sh` if CS-024 auto-deploy isn't ready yet.~~ Auto-deploy is live (CS-024 done early, #6): merging updates chlorosat.com.
